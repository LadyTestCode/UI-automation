...
def pytest_addoption(parser):
    ...
    parser.addoption("--browser",
                     action="store",
                     default="Sber",
                     help='available browsers: IE, Sber, Chrome, Edge',
...
# Фикстура драйвера для запуска браузера - общий учебный вариант
...
# Фикстура драйвера для запуска браузера - мой вариант
